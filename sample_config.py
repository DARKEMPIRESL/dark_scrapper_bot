...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "dark_scrapper_bot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "dark_scrapper_bot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/dark_scrapper_bot")
    ...
    # please reopen
    # https://github.com/DARKEMPIRESL/dark_scrapper_bot/issues/1#issue-1252144494
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/dark_scrapper_bot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "Managed With ☕️ By @ImDark_Empire | @SLBotOfficial")
